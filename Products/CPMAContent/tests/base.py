...
def setup_product():
    ...
    import Products.CPMAContent
    zcml.load_config('configure.zcml', Products.CPMAContent)
    ...
    ztc.installPackage('Products.CPMAContent')
...
setup_product()
ptc.setupPloneSite(products=['Products.CPMAContent'])
